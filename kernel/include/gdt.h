...
#define SEGMENT_DESCRIPTOR_BASE_MID(ADDR)                                      \
  (((uint64_t)((ADDR) >> 16) & 0xFF) << 32)
#define SEGMENT_DESCRIPTOR_BASE_UPPER(ADDR)                                    \
  (((uint64_t)((ADDR) >> 24) & 0xFF) << 56)
...
#define SEGMENT_DESCRIPTOR_LIMIT_UPPER(ADDR)                                   \
  (((uint64_t)((ADDR) >> 16) & 0xF) << 48)
